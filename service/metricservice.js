...
function getChannelCount(){
    return bcservice.getAllChannels().length
}
...
function* getStatusGenerate(channelName){
    ...
    return {'chaincodeCount':chaincodeCount.c,'txCount':txCount.c,'latestBlock':blockCount.c,'peerCount':peerCount, 'channelCount': channelCount}
}
